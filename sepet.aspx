<%@ Page Title="" Language="C#" MasterPageFile="~/satınal.master" AutoEventWireup="true" CodeFile="sepet.aspx.cs" Inherits="sepet" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

  <h4> SEPETE EKLENEN ÜRÜNLER </h4>
    ...
    <table width="600px" cellspacing="0" cellpadding="2">
                   	  ...
                   	  <tr bgcolor="#CCCCCC">
                            ...
                            <th width="60" align="center">Ürünlerin Toplam Fiyatı </th> 
                            <th width="160" align="center">Satın Alınan Tarihler</th> 
