<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adim2.aspx.cs" Inherits="adim2" %>
...
<body id="subpage">
	...
	<div id="templatemo_header">
    	<div id="site_title"><h2><a href="#">PComponents</a></h2></div>
    ...
    <div id="templatemo_main">
      ...
      <h2>ŞİFREMİ UNUTTUM</h2>
        <div id="content">
            ...
            <tr>
                <td class="style2">
                    <asp:Label ID="lbl_soru" runat="server" Text="Label"></asp:Label>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            ...
            <tr>
                <td class="style2">
                    <asp:Button ID="btn_ileri" runat="server" Text="İleri" 
                        onclick="btn_ileri_Click" />
                </td>
                <td>
                    &nbsp;</td>
            </tr>
